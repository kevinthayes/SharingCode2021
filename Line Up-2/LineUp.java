...
public class LineUp extends JComponent //implements Runnable
{
    ...
    {
        Thread stickFigureThread1 = new Thread( figure1 );
        Thread stickFigureThread2 = new Thread( figure2 );
        Thread stickFigureThread3 = new Thread( figure3 );
        Thread stickFigureThread4 = new Thread( figure4 );
        Thread groundThread = new Thread( ground );
        
        stickFigureThread1.start();
        stickFigureThread2.start();
        stickFigureThread3.start();
        stickFigureThread4.start();
        groundThread.start();
    }
